privileged aspect TreSync extends Sync {

    pointcut build(Semaforo[] sem): execution(Incrocio.new(..)) && args(*, sem) && if(sem.length == 3);

    pointcut go(Incrocio inc): execution(* Incrocio.go()) && this(inc) && if(inc.semafori.length == 3);
